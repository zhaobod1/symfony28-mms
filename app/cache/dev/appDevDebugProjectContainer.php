...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app.form.type.addmod' => 'getApp_Form_Type_AddmodService',
            'app_user.profile' => 'getAppUser_ProfileService',
            'app_user.registration' => 'getAppUser_RegistrationService',
     ...
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Form\Type\ProfileFormType A AppBundle\Form\Type\ProfileFormType instance
     */
    protected function getApp_Form_ProfileService()
    {
        return $this->services['app.form.profile'] = new \AppBundle\Form\Type\ProfileFormType($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    {
        return $this->services['app.form.registration'] = new \AppBundle\Form\Type\RegistrationFormType();
    }

    /**
     * Gets the 'app.form.type.addmod' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Form\Type\AddModFormType A AppBundle\Form\Type\AddModFormType instance
     */
    protected function getApp_Form_Type_AddmodService()
    {
        return $this->services['app.form.type.addmod'] = new \AppBundle\Form\Type\AddModFormType();
    }

    /**
     * Gets the 'app_user.profile' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\EventListener\ProfileListener A AppBundle\EventListener\ProfileListener instance
     */
    protected function getAppUser_ProfileService()
    {
        return $this->services['app_user.profile'] = new \AppBundle\EventListener\ProfileListener();
    }

    /**
     * Gets the 'app_user.registration' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getAppUser_RegistrationService()
    {
        return $this->services['app_user.registration'] = new \AppBundle\EventListener\RegistrationListener($this->get('router'));
    }
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addSubscriberService('app_user.profile', 'AppBundle\\EventListener\\ProfileListener');
        $instance->addSubscriberService('app_user.registration', 'AppBundle\\EventListener\\RegistrationListener');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'sf2_mms', 'user' => 'root', 'password' => 'huo15com', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_e37fe0fd4d5d19b19d71c8e4c48facc79768ce46e1c838d6bbac825fabd9ce66');
    ...
    {
        return $this->services['fos_user.profile.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_profile_form', 'AppBundle\\Form\\Type\\ProfileFormType', array(0 => 'Profile', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.registration.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_registration_form', 'AppBundle\\Form\\Type\\RegistrationFormType', array(0 => 'Registration', 1 => 'Default'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $g = new \Symfony\Component\HttpFoundation\RequestMatcher('^/user/ulist');

        $h = new \Symfony\Component\HttpFoundation\RequestMatcher('^/user/index');

        $i = new \Symfony\Component\HttpFoundation\RequestMatcher('^/user/help');

        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/profile/edit');

        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/user/deleteUser.*');

        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/user/addNewMem.*');

        $m = new \Symfony\Component\HttpFoundation\RequestMatcher('^/user/authList.*');

        $n = new \Symfony\Component\HttpFoundation\RequestMatcher('^/user/addDepartment.*');

        $o = new \Symfony\Component\HttpFoundation\RequestMatcher('^/user/deleteDepartment.*');

        $p = new \Symfony\Component\HttpFoundation\RequestMatcher('^/modules/modList.*');

        $q = new \Symfony\Component\HttpFoundation\RequestMatcher('^/modules/dataList.*');

        $r = new \Symfony\Component\HttpFoundation\RequestMatcher('^/modules/addData.*');

        $s = new \Symfony\Component\HttpFoundation\RequestMatcher('^/modules/addMod');

        $t = new \Symfony\Component\HttpFoundation\RequestMatcher('^/modules/adMod?moduleId.*');

        $u = new \Symfony\Component\HttpFoundation\RequestMatcher('^/login$');

        $v = new \Symfony\Component\HttpFoundation\RequestMatcher('^/_');

        $w = new \Symfony\Component\HttpFoundation\RequestMatcher('^/register');

        $x = new \Symfony\Component\HttpFoundation\RequestMatcher('^/resetting');

        $y = new \Symfony\Component\HttpFoundation\RequestMatcher('^/$');

        $z = new \Symfony\Component\Security\Http\AccessMap();
        $z->add($g, array(0 => 'ROLE_USER'), NULL);
        $z->add($h, array(0 => 'ROLE_USER'), NULL);
        $z->add($i, array(0 => 'ROLE_USER'), NULL);
        $z->add($j, array(0 => 'ROLE_USER'), NULL);
        $z->add($k, array(0 => 'ROLE_ADMIN'), NULL);
        $z->add($l, array(0 => 'ROLE_ADMIN'), NULL);
        $z->add($m, array(0 => 'ROLE_ADMIN'), NULL);
        $z->add($n, array(0 => 'ROLE_ADMIN'), NULL);
        $z->add($o, array(0 => 'ROLE_ADMIN'), NULL);
        $z->add($p, array(0 => 'ROLE_USER'), NULL);
        $z->add($q, array(0 => 'ROLE_USER'), NULL);
        $z->add($r, array(0 => 'ROLE_USER'), NULL);
        $z->add($s, array(0 => 'ROLE_SUPER_ADMIN'), NULL);
        $z->add($t, array(0 => 'ROLE_ADMIN'), NULL);
        ...
        $z->add($x, array(0 => 'ROLE_ADMIN'), NULL);
        $z->add($y, array(0 => 'ROLE_USER'), NULL);
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($z, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('fos_user.user_provider.username')), 'main', $a, $c), 2 => $ba, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, $this->get('security.authentication.session_strategy'), $aa, 'main', $ca, $da, array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $c, $this->get('security.csrf.token_manager')), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '58affeb9a83a17.29971650', $a, $f), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $z, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $aa, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $aa, '/login', false), NULL, NULL, $a, false));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \AppBundle\Twig\urldecodeExtension());
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('33d362880dfa2830ac985c1f1ad0bbe29281f140');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_port' => NULL,
            'database_name' => 'sf2_mms',
            'database_user' => 'root',
            'database_password' => 'huo15com',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => '33d362880dfa2830ac985c1f1ad0bbe29281f140',
            'locale' => 'zh_CN',
            ...
            'kernel.secret' => '33d362880dfa2830ac985c1f1ad0bbe29281f140',
            ...
            'fos_user.profile.form.type' => 'AppBundle\\Form\\Type\\ProfileFormType',
            ...
            'fos_user.registration.form.type' => 'AppBundle\\Form\\Type\\RegistrationFormType',
